            ...
            <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
              <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-white sm:text-4xl md:mx-auto">
                <span className="relative inline-block">
                  ...
                  <span className="relative">OV :</span>
                </span>{' '}
                Le soin parfait pour vos vêtements.
              </h2>
              <p className="text-base text-indigo-100 md:text-lg">
                Faites briller vos vêtements ! Nous offrons des services de qualité pour que vos vêtements retrouvent leur éclat d'origine. Livraison rapide et service impeccable. Venez nous voir dès aujourd'hui !
              </p>
            </div>
            <div>
              <a
